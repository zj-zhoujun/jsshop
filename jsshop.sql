...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='插件表';
...
-- ----------------------------
INSERT INTO `jshop_advertisement` VALUES ('1', '1', '广告', '4a6f179672c7f1ec02582eb104607dd2', '4', '100', '1540172656', '1540460353', 'tpl1_slider', '2');
...
-- ----------------------------
INSERT INTO `jshop_advert_position` VALUES ('1', '首页广告位', 'tpl1_slider', '1540172590', '1540221472', '1', '100');
...
-- ----------------------------
INSERT INTO `jshop_article` VALUES ('1', '测试', 'a422f452969f04e4493af4728eec3ab8', '<p>这是测试标题</p>', '1', '1540179322', '1540453631', '100', '1', null);
...
-- ----------------------------
INSERT INTO `jshop_article_type` VALUES ('1', '0', '111');
INSERT INTO `jshop_article_type` VALUES ('2', '1', '1');
...
CREATE TABLE `jshop_bill_delivery_items` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='发货单详情表';
...
INSERT INTO `jshop_brand` VALUES ('16', '测试品牌', 'e300e8a0ae4af3a490a88c8196d7bd53', '100', '1540463446', '1540463446');
INSERT INTO `jshop_brand` VALUES ('17', '测试品牌', 'c667372acee834c7e4bc36fb51c3bee9', '100', '1540463441', '1540463441');
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='购物车表（每个用户最多加100条信息）';
...
CREATE TABLE `jshop_clerk` (
  ...
  `isdel` bigint(12) unsigned DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='店铺店员关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='商品表';
...
INSERT INTO `jshop_goods` VALUES ('11', '99', '33', '999', '0.00', '0.00', '0.00', '48d7337ff7a02c6a98e866752b1292b7', '3', '1', '14', '1', '1', '0', '0', '0.00', '', '<p><img src=\"https://b2c.jihainet.com/static/uploads/45/82/06/5bcc1fe98fed0.jpg\"/></p><p><img src=\"https://b2c.jihainet.com/static/uploads/7f/93/09/5bcc1fe997d8e.jpg\"/></p><p><img src=\"https://b2c.jihainet.com/static/uploads/ef/01/9a/5bcc1fe9dfdad.png\"/></p><p><img src=\"https://b2c.jihainet.com/static/uploads/19/b2/5e/5bcc1fe9e4054.jpg\"/></p><p><br/></p>', '', '', '0', '0', '0', null, null, '100', '2', '2', null, null, '1540119675', '1540119675');
INSERT INTO `jshop_goods` VALUES ('12', 'aaaaaa', '测试商品', '发达水电费阿斯蒂芬阿发', '122.00', '12.00', '120.00', '2d05db94e526310e8684607a15c98e45', '3', '1', '16', '1', '1', '122', '0', '122.00', '122', '<p>sdfafsfassdf</p>', '', '', '0', '0', '0', null, null, '100', '1', '1', null, null, '1540463420', '1540463420');
INSERT INTO `jshop_goods` VALUES ('13', '0012', '好看的山谷', '阿萨德打撒撒多所大撒多', '12.00', '12.00', '23.00', '2729b3b006a1b409f02b9d58ac860f31', '3', '1', '5', '1', '1', '213', '0', '101.00', '1', '<p>现在长春装修自行车</p>', 'a:2:{s:6:\"颜色\";a:1:{i:0;s:6:\"红色\";}s:6:\"规格\";a:1:{i:0;s:7:\"规格1\";}}', '', '0', '0', '0', null, null, '100', '1', '1', null, null, '1540463416', '1540463416');
INSERT INTO `jshop_goods` VALUES ('16', '321321321', '213213', '', '999.00', '9999.00', '9999.00', '8c2ee9e17f1dfb42f773109b2776ff81', '3', '1', '0', '1', '1', '999', '0', '321.00', '件', '', '', '', '0', '0', '0', null, null, '100', '1', '1', null, null, '1540463411', '1540463411');
...
-- ----------------------------
INSERT INTO `jshop_goods_cat` VALUES ('3', '0', '精选上衣', '0', '100', '', null);
INSERT INTO `jshop_goods_cat` VALUES ('4', '0', '浪漫裙装', '0', '100', '', null);
INSERT INTO `jshop_goods_cat` VALUES ('5', '0', '女装下装', '0', '100', '', null);
INSERT INTO `jshop_goods_cat` VALUES ('6', '9', '家居服', '1', '100', 'a496465d657cd5fbeb90f10e25e16086', '1539941157');
INSERT INTO `jshop_goods_cat` VALUES ('8', '0', '女鞋', '0', '100', '', null);
INSERT INTO `jshop_goods_cat` VALUES ('9', '0', '女包', '0', '100', '', null);
INSERT INTO `jshop_goods_cat` VALUES ('10', '3', '毛呢外套', '0', '100', 'a422f452969f04e4493af4728eec3ab8', '1540172964');
INSERT INTO `jshop_goods_cat` VALUES ('11', '3', '羽绒服', '0', '100', '9ca906f23d05dc9db1de552bfefa36fc', '1539940964');
INSERT INTO `jshop_goods_cat` VALUES ('12', '3', '棉服', '0', '100', 'f4f98826b4db681ab21433c3fecc8326', '1539940902');
INSERT INTO `jshop_goods_cat` VALUES ('13', '3', '卫衣', '0', '100', 'b9857035fa36ca4fbbeadc72e3ead0bb', '1539940850');
INSERT INTO `jshop_goods_cat` VALUES ('14', '3', '毛针织衫', '0', '100', 'de21cc610a10fada67ef1974bdacf9fb', '1539940683');
INSERT INTO `jshop_goods_cat` VALUES ('15', '9', '皮草', '1', '100', 'b68a51db26eb5c35e4f9b16f0c41d455', '1540459969');
INSERT INTO `jshop_goods_cat` VALUES ('16', '3', '衬衫', '0', '100', 'db1b8c0257b08a5542e10125fcef8fc1', '1539940635');
INSERT INTO `jshop_goods_cat` VALUES ('17', '3', 'T恤', '0', '100', 'd74ea8dc93080b9e4ae686f4a14dbe96', '1539940585');
INSERT INTO `jshop_goods_cat` VALUES ('18', '0', '风衣', '1', '100', 'd47c3377663dfbb925ea9a40a1488155', '1540186606');
INSERT INTO `jshop_goods_cat` VALUES ('19', '9', '单肩包', '0', '100', '443c2d9ddb8b769ceddcd6f2bee5908b', '1539941054');
INSERT INTO `jshop_goods_cat` VALUES ('20', '9', '斜挎包', '0', '100', 'dea52ed56c999be5583ba568aff9029a', '1539941097');
INSERT INTO `jshop_goods_cat` VALUES ('21', '9', '手提包', '0', '100', '8fec591f6b83a0edaa973e3ea35ae8ee', '1539941013');
INSERT INTO `jshop_goods_cat` VALUES ('22', '8', '高跟鞋', '0', '100', 'e51a16d2996d29939e7031434fbc3c29', '1540172563');
INSERT INTO `jshop_goods_cat` VALUES ('23', '8', '运动鞋', '0', '100', 'fe91f59b549fab49ca2db1ea9883f8d3', '1540172488');
INSERT INTO `jshop_goods_cat` VALUES ('24', '8', '帆布鞋', '0', '100', 'cd2c104a7d9100e12f7529d6b2c3f209', '1540172536');
INSERT INTO `jshop_goods_cat` VALUES ('26', '5', '牛仔裤', '0', '100', '2776b0176aa478be959d762326c4e58f', '1540459686');
INSERT INTO `jshop_goods_cat` VALUES ('27', '5', '九分裤', '0', '100', '160b5dfcb243deffb794ce3d0ac48431', '1540172257');
INSERT INTO `jshop_goods_cat` VALUES ('28', '5', '直筒裤', '0', '100', '7e9d7a60a7d40c9e908c45ed092de558', '1540172331');
INSERT INTO `jshop_goods_cat` VALUES ('29', '4', '连衣裙', '0', '100', 'aea2675adb10467d6dfbd92ab9321a33', '1540172373');
INSERT INTO `jshop_goods_cat` VALUES ('30', '4', '碎花裙', '0', '100', 'f8b31c241ad346fceb55f83fcf2874bb', '1540172412');
INSERT INTO `jshop_goods_cat` VALUES ('31', '4', '短裙', '0', '100', 'af547e9f2513965d6eaf56b4dcc276ec', '1540172457');
INSERT INTO `jshop_goods_cat` VALUES ('32', '9', '啊发发', '0', '100', '', null);
INSERT INTO `jshop_goods_cat` VALUES ('33', '9', '456', '0', '100', 'b55ea82d8c05abdc06da42331ac3820b', null);
...
-- ----------------------------
INSERT INTO `jshop_images` VALUES ('022bbf0657d3b9ed38a97dd746b2e84c', '0.jpg', 'https://b2c.jihainet.com/static/uploads/e8/87/87/5bca86083380f.jpg', '', 'local', '1539999240', null);
INSERT INTO `jshop_images` VALUES ('0385f8221a24f7dd3ac09db1b78fd8d0', 'b3.jpg', 'https://b2c.jihainet.com/static/uploads/97/06/7d/5bd0271e42170.jpg', '', 'local', '1540368158', null);
INSERT INTO `jshop_images` VALUES ('03ca799895a0b094bca75116e322539c', '裂帛.png', 'http://b2c.jihainet.com/static/uploads/2d/6f/d5/5ba9e21e12188.png', '', 'local', '1537860126', null);
INSERT INTO `jshop_images` VALUES ('052d4af90ec88851c10982bf7fdfa763', 'O1CN012H2BUpZVbIA3OwR_!!0-item_pic.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/a4/cd/ec/5bc9a989cb351.jpg', '', 'local', '1539942793', null);
INSERT INTO `jshop_images` VALUES ('070fe78d0712b1ceaa3cdb7240f57246', 'O1CN012AZtKI6Iz1SeIEH_!!277648218.jpg', 'https://b2c.jihainet.com/static/uploads/76/7e/81/5bc9a5c7bbc8e.jpg', '', 'local', '1539941831', null);
INSERT INTO `jshop_images` VALUES ('127fe7340aec7641c981c73a3ccff801', 'TB2RYMOX4WYBuNjy1zkXXXGGpXa_!!173275708.jpg_430x43', 'https://b2c.jihainet.com/static/uploads/d1/d7/cb/5bc9a6dee7ebb.jpg', '', 'local', '1539942110', null);
INSERT INTO `jshop_images` VALUES ('12c60848aba2425c7a79e18a7ee1b8f8', '翠岭77平米户型.jpg', 'https://b2c.jihainet.com/static/uploads/45/82/06/5bcc1fe98fed0.jpg', '', 'local', '1540104169', null);
INSERT INTO `jshop_images` VALUES ('14b44959327363e274c8a2ba9dba3ace', '玖姿.png', 'http://b2c.jihainet.com/static/uploads/0e/f2/b1/5ba9e21f0dd1a.png', '', 'local', '1537860127', null);
INSERT INTO `jshop_images` VALUES ('1575deb7e275d200f105ba941d815ab5', 'O1CN011jjW1HVm2eoMd1M_!!2856524584.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/ce/ae/8d/5bc9a81609585.jpg', '', 'local', '1539942422', null);
INSERT INTO `jshop_images` VALUES ('160b5dfcb243deffb794ce3d0ac48431', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/3f/a6/7f/5bcd29de34a05.jpg', '', 'local', '1540172254', null);
INSERT INTO `jshop_images` VALUES ('1ce148f164e099cfa15017eae9c0324d', '773245_limingsky.png', 'https://b2c.jihainet.com/static/uploads/7c/0a/fd/5bc9a3125560c.png', '', 'local', '1539941138', null);
INSERT INTO `jshop_images` VALUES ('1e6a5117d2a6082b565ad4d1c9e58c0d', 'goods1_3.jpg', 'http://b2c.jihainet.com/static/uploads/9f/81/10/5ba9e786c45eb.jpg', '', 'local', '1537861510', null);
INSERT INTO `jshop_images` VALUES ('24eea7da4b715ed23ed2e403a376223f', '未命名表单 (4).png', 'https://b2c.jihainet.com/static/uploads/84/38/75/5bc98bc9a619d.png', '', 'local', '1539935177', null);
INSERT INTO `jshop_images` VALUES ('2606549d84e2ded23935ddcc2d562c43', 'goods1_1.jpg', 'http://b2c.jihainet.com/static/uploads/df/6d/df/5ba9e78ac77d0.jpg', '', 'local', '1537861514', null);
INSERT INTO `jshop_images` VALUES ('265cc34a43e319d39a454666a2592bf2', 'O1CN011FO2zOzv9iYed2a_!!2946030476.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/08/d0/3a/5bc9ab837a41a.jpg', '', 'local', '1539943299', null);
INSERT INTO `jshop_images` VALUES ('2660dd8bb5ef408b75d3ac78d7a45c72', '两三事.png', 'http://b2c.jihainet.com/static/uploads/a5/fc/e3/5ba9e21b64271.png', '', 'local', '1537860123', null);
INSERT INTO `jshop_images` VALUES ('26717fd8e2314719ec5b1f9f0dfccce3', 'O1CN011jjW1JidazOFH2I_!!2856524584.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/e9/ac/a3/5bc9a8167a827.jpg', '', 'local', '1539942422', null);
INSERT INTO `jshop_images` VALUES ('2776b0176aa478be959d762326c4e58f', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/ba/6b/4b/5bcd29715fa78.jpg', '', 'local', '1540172145', null);
INSERT INTO `jshop_images` VALUES ('38b53dadcfeb35a77678a0a9cfdb7a7c', '茵曼.png', 'http://b2c.jihainet.com/static/uploads/a2/3d/6e/5ba9e21ccf87e.png', '', 'local', '1537860124', null);
INSERT INTO `jshop_images` VALUES ('3b509fa01f8b7fbc6163fd7c591314fd', 'O1CN012AZtKFGQ1bonLYH_!!277648218.jpg', 'https://b2c.jihainet.com/static/uploads/b7/9f/72/5bc9a5c440801.jpg', '', 'local', '1539941828', null);
INSERT INTO `jshop_images` VALUES ('3e1c30dd1125de24e5395d3cd39ef5d8', 'O1CN012AZtKGxGsMBKldW_!!277648218.jpg', 'https://b2c.jihainet.com/static/uploads/af/00/b7/5bc9a5b89bd9a.jpg', '', 'local', '1539941816', null);
INSERT INTO `jshop_images` VALUES ('443c2d9ddb8b769ceddcd6f2bee5908b', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/92/70/83/5bc9a2bc7a634.jpg', '', 'local', '1539941052', null);
INSERT INTO `jshop_images` VALUES ('4a6f179672c7f1ec02582eb104607dd2', 'TB1CYIFi9zqK1RjSZFjSuvlCFXa.jpg', 'https://b2c.jihainet.com/static/uploads/9f/c9/54/5bcd2b69d8e2d.jpg', '', 'local', '1540172649', null);
INSERT INTO `jshop_images` VALUES ('4f86bd749dddd098403fc44a1e473643', 'TB1Qz.HX3mTBuNjy1XbXXaMrVXa_!!0-item_pic.jpg_430x4', 'https://b2c.jihainet.com/static/uploads/0b/b2/ff/5bc9a6de5361c.jpg', '', 'local', '1539942110', null);
INSERT INTO `jshop_images` VALUES ('50f61b1f46866f1f7664cd4ab8ae62ec', 'TB1SOQOdr2pK1RjSZFsSuuNlXXa.jpg', 'https://b2c.jihainet.com/static/uploads/f5/f1/c2/5bcd2c57a660f.jpg', '', 'local', '1540172887', null);
INSERT INTO `jshop_images` VALUES ('51496b49fdad4fc6f359cb6a29e6596a', 'O1CN012AZtKHCituSHjfW_!!277648218.jpg', 'https://b2c.jihainet.com/static/uploads/4c/28/57/5bc9a5c53aa6e.jpg', '', 'local', '1539941829', null);
INSERT INTO `jshop_images` VALUES ('54a8b2f0465e01d9e6f13104181728a5', 'O1CN012H2BUk821QpMLUv_!!3241519092.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/99/99/1d/5bc9a98960531.jpg', '', 'local', '1539942793', null);
INSERT INTO `jshop_images` VALUES ('55cbc9c9642052f18e989578ae89f4e0', 'b1.jpg', 'https://b2c.jihainet.com/static/uploads/cd/5a/00/5bd0271e324f1.jpg', '', 'local', '1540368158', null);
INSERT INTO `jshop_images` VALUES ('56020c21a0e3b07e9906c1c6f06bee6a', '依嬅莎.jpg', 'http://b2c.jihainet.com/static/uploads/d6/a3/95/5ba9e21a032e0.jpg', '', 'local', '1537860122', null);
INSERT INTO `jshop_images` VALUES ('6554e73ccd5a4b81b196b5ec3f412d0c', 'O1CN0129E4qsGtc2HGKtz_!!736758035.jpg_430x430q90.j', 'https://b2c.jihainet.com/static/uploads/b3/16/38/5bc9a50662303.jpg', '', 'local', '1539941638', null);
INSERT INTO `jshop_images` VALUES ('6ee0f5a5ac6c53418852ee6cc78aeb48', '430x430q90.jpg', 'https://b2c.jihainet.com/static/uploads/8c/f8/53/5bc9a3b2916a4.jpg', '', 'local', '1539941298', null);
INSERT INTO `jshop_images` VALUES ('708ef31a7ba3d766a9a0424aeb8b8481', 'goods1_5.jpg', 'http://b2c.jihainet.com/static/uploads/e9/bc/30/5ba9e786e2f66.jpg', '', 'local', '1537861510', null);
INSERT INTO `jshop_images` VALUES ('78881593fcf3d651b5c0e69e6e8eba97', '波司登.png', 'http://b2c.jihainet.com/static/uploads/eb/72/fe/5ba9e21a61aa1.png', '', 'local', '1537860122', null);
INSERT INTO `jshop_images` VALUES ('7e9d7a60a7d40c9e908c45ed092de558', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/f5/71/ea/5bcd2a29965d7.jpg', '', 'local', '1540172329', null);
INSERT INTO `jshop_images` VALUES ('8809c039c5afd2af6610a3111bb7d4b7', 'u=3112331775,1705654587&fm=27&gp=0.jpg', '/static/uploads/b4/10/f7/5bab3d8e8847e.jpg', '', 'local', '1537949070', null);
INSERT INTO `jshop_images` VALUES ('897fad09b83c0f847f91843fdb2282a2', 'O1CN012H2BUlWm7Rnugw5_!!3241519092.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/51/3a/27/5bc9a98957a8c.jpg', '', 'local', '1539942793', null);
INSERT INTO `jshop_images` VALUES ('8ef876168670ddb5c37941a867172f28', 'goods1_4.jpg', 'http://b2c.jihainet.com/static/uploads/5b/ff/67/5ba9e78294c5a.jpg', '', 'local', '1537861506', null);
INSERT INTO `jshop_images` VALUES ('8fec591f6b83a0edaa973e3ea35ae8ee', '430x430q90.jpg', 'https://b2c.jihainet.com/static/uploads/72/3e/1e/5bc9a293a44ee.jpg', '', 'local', '1539941011', null);
INSERT INTO `jshop_images` VALUES ('9207c7644b6a6a3b7b29195a6a9d7a3b', 'O1CN011FO2zThCdx2pftI_!!2946030476.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/83/37/8a/5bc9ab85d0414.jpg', '', 'local', '1539943301', null);
INSERT INTO `jshop_images` VALUES ('9422a9632cae4f6c45a171c58a9f776c', '千仞岗.png', 'http://b2c.jihainet.com/static/uploads/21/10/c9/5ba9e21b1c076.png', '', 'local', '1537860123', null);
INSERT INTO `jshop_images` VALUES ('9b7051cf017685b0c3a48c4658d48272', 'TB2_LVcev9TBuNjy0FcXXbeiFXa_!!173275708.jpg_430x43', 'https://b2c.jihainet.com/static/uploads/58/57/c8/5bc9a6de50a60.jpg', '', 'local', '1539942110', null);
INSERT INTO `jshop_images` VALUES ('9ca906f23d05dc9db1de552bfefa36fc', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/19/92/5a/5bc9a262427d4.jpg', '', 'local', '1539940962', null);
INSERT INTO `jshop_images` VALUES ('9f906ea7c6d4d785946f3f54e3717c59', 'O1CN0129E4qt3dH4bv5Fl_!!736758035.png_430x430q90.j', 'https://b2c.jihainet.com/static/uploads/2e/1b/3b/5bc9a50900998.jpg', '', 'local', '1539941641', null);
INSERT INTO `jshop_images` VALUES ('a422f452969f04e4493af4728eec3ab8', 'O1CN011EoK6MJ0F08K4mr_!!0-saturn_solar.jpg_270x270', 'https://b2c.jihainet.com/static/uploads/04/f9/ec/5bcd2ca278a34.jpg', '', 'local', '1540172962', null);
INSERT INTO `jshop_images` VALUES ('a496465d657cd5fbeb90f10e25e16086', '123.jpg', 'https://b2c.jihainet.com/static/uploads/11/e9/e7/5bc9a31259dda.jpg', '', 'local', '1539941138', null);
INSERT INTO `jshop_images` VALUES ('a5fd9ad6780b56a9ecece1d1ae38b18e', '9252150_174018365301_2.png', 'https://b2c.jihainet.com/static/uploads/8e/44/1c/5bc9a31283f70.png', '', 'local', '1539941138', null);
INSERT INTO `jshop_images` VALUES ('aea2675adb10467d6dfbd92ab9321a33', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/7a/20/9c/5bcd2a537bf1f.jpg', '', 'local', '1540172371', null);
INSERT INTO `jshop_images` VALUES ('af547e9f2513965d6eaf56b4dcc276ec', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/f2/1d/d0/5bcd2aa788869.jpg', '', 'local', '1540172455', null);
INSERT INTO `jshop_images` VALUES ('b419e4164d5726d057b2ae195f9a96df', 'goods1_2.jpg', 'http://b2c.jihainet.com/static/uploads/b7/03/ed/5ba9e78922087.jpg', '', 'local', '1537861513', null);
INSERT INTO `jshop_images` VALUES ('b55ea82d8c05abdc06da42331ac3820b', 'actAug_sharePic.jpg', 'https://b2c.jihainet.com/static/uploads/cd/57/0d/5bcdaa110ed6f.jpg', '', 'local', '1540205073', null);
INSERT INTO `jshop_images` VALUES ('b68a51db26eb5c35e4f9b16f0c41d455', 'O1CN011DHW7IubkRgdFiS_!!0-saturn_solar.jpg_270x270', 'https://b2c.jihainet.com/static/uploads/fa/6c/24/5bcd2cd0edf0d.jpg', '', 'local', '1540173008', null);
INSERT INTO `jshop_images` VALUES ('b9857035fa36ca4fbbeadc72e3ead0bb', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/34/13/4a/5bc9a1f05e5c6.jpg', '', 'local', '1539940848', null);
INSERT INTO `jshop_images` VALUES ('b9d70b1b457f77b3796cd4229c9b0aa2', '水墨清华.jpg', 'http://b2c.jihainet.com/static/uploads/43/cb/eb/5ba9e21d41d70.jpg', '', 'local', '1537860125', null);
INSERT INTO `jshop_images` VALUES ('ba2be1b85728a546038f1c783e28582c', 'O1CN011jjW1JBSBRDj7YA_!!2856524584.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/7e/18/48/5bc9a816ce21b.jpg', '', 'local', '1539942422', null);
INSERT INTO `jshop_images` VALUES ('c667372acee834c7e4bc36fb51c3bee9', '110425022312-0.jpg', 'https://b2c.jihainet.com/static/uploads/b8/73/29/5bce8cb00be24.jpg', '', 'local', '1540263088', null);
INSERT INTO `jshop_images` VALUES ('cd2c104a7d9100e12f7529d6b2c3f209', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/67/24/48/5bcd2af7116a3.jpg', '', 'local', '1540172535', null);
INSERT INTO `jshop_images` VALUES ('d47c3377663dfbb925ea9a40a1488155', '250x250.jpg', 'https://b2c.jihainet.com/static/uploads/cc/15/4b/5bc9a02015a35.jpg', '', 'local', '1539940384', null);
INSERT INTO `jshop_images` VALUES ('d6164aafe1d26463fb077b28e919c861', 'O1CN011FO2zV7NDZHC7HV_!!2946030476.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/46/4e/5e/5bc9ab85b6541.jpg', '', 'local', '1539943301', null);
INSERT INTO `jshop_images` VALUES ('d621f6c85afaaf113fdbfd630bfefb65', 'b2.jpg', 'https://b2c.jihainet.com/static/uploads/46/1e/1c/5bd0271e3c8fa.jpg', '', 'local', '1540368158', null);
INSERT INTO `jshop_images` VALUES ('d74ea8dc93080b9e4ae686f4a14dbe96', '160x160q90.jpg', 'https://b2c.jihainet.com/static/uploads/15/2d/d3/5bc9a0e70ac7f.jpg', '', 'local', '1539940583', null);
INSERT INTO `jshop_images` VALUES ('d80e32cf4665fb60ef9b632466c835e2', '艾尚臣.png', 'http://b2c.jihainet.com/static/uploads/4f/4d/86/5ba9e21b16403.png', '', 'local', '1537860123', null);
INSERT INTO `jshop_images` VALUES ('d8f07a89b3f8d35b74ed6b21c21a180e', 'u=1134602731,3644147114&fm=27&gp=0.jpg', 'https://b2c.jihainet.com/static/uploads/eb/96/5b/5bcac64e3986e.jpg', '', 'local', '1540015694', null);
INSERT INTO `jshop_images` VALUES ('d9543b910358d02d1c60b859dd05c8aa', '定坊嘉园77户型.jpg', 'https://b2c.jihainet.com/static/uploads/7f/93/09/5bcc1fe997d8e.jpg', '', 'local', '1540104169', null);
INSERT INTO `jshop_images` VALUES ('db1b8c0257b08a5542e10125fcef8fc1', '160x160q90.jpg', 'https://b2c.jihainet.com/static/uploads/17/22/8b/5bc9a118068ec.jpg', '', 'local', '1539940632', null);
INSERT INTO `jshop_images` VALUES ('dcc56740b60745aac85a1b0433767a8d', '恩裳.png', 'http://b2c.jihainet.com/static/uploads/a7/fb/46/5ba9e21e33314.png', '', 'local', '1537860126', null);
INSERT INTO `jshop_images` VALUES ('de21cc610a10fada67ef1974bdacf9fb', '160x160q90.jpg', 'https://b2c.jihainet.com/static/uploads/dd/da/cb/5bc9a14a0d106.jpg', '', 'local', '1539940682', null);
INSERT INTO `jshop_images` VALUES ('dea52ed56c999be5583ba568aff9029a', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/e4/95/26/5bc9a2e8277ce.jpg', '', 'local', '1539941096', null);
INSERT INTO `jshop_images` VALUES ('deed2e4f1c54f87eb672ad8c444ba229', 'O1CN011FO2zWdwMIOhIb0_!!0-item_pic.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/0c/4b/01/5bc9ab85cc335.jpg', '', 'local', '1539943301', null);
INSERT INTO `jshop_images` VALUES ('def45acaee091fb6ab66634b76a5ce48', 'UR.jpeg', 'http://b2c.jihainet.com/static/uploads/d5/02/ee/5ba9e21d4ff8b.jpeg', '', 'local', '1537860125', null);
INSERT INTO `jshop_images` VALUES ('e066155b201c578f5cd467616b0483b2', '拉夏贝尔.jpg', 'http://b2c.jihainet.com/static/uploads/54/82/d1/5ba9e21dcbd68.jpg', '', 'local', '1537860125', null);
INSERT INTO `jshop_images` VALUES ('e214d5d3a8412df8f9c771a895425916', 'LMZ1537428876.png', 'https://b2c.jihainet.com/static/uploads/75/91/20/5bc9a3124dd0b.png', '', 'local', '1539941138', null);
INSERT INTO `jshop_images` VALUES ('e51a16d2996d29939e7031434fbc3c29', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/05/3b/e8/5bcd2b11a2990.jpg', '', 'local', '1540172561', null);
INSERT INTO `jshop_images` VALUES ('e75777b3c40755d4d0febd7696452150', 'DKCHENPIN.jpg', 'http://b2c.jihainet.com/static/uploads/9e/17/a8/5ba9e21a4d831.jpg', '', 'local', '1537860122', null);
INSERT INTO `jshop_images` VALUES ('edc14b67f169e0512acf6f20a253d263', 'b4.jpg', 'https://b2c.jihainet.com/static/uploads/09/e1/ce/5bd0271e5fa2d.jpg', '', 'local', '1540368158', null);
INSERT INTO `jshop_images` VALUES ('f0007202b0603ea8263da17b53ff0b7a', '0751ef339ada6598c11199991ddd14a9.jpg', '/static/uploads/e5/f9/a4/5bac52e9d3c2e.jpg', '', 'local', '1538020073', null);
INSERT INTO `jshop_images` VALUES ('f4f98826b4db681ab21433c3fecc8326', '430x430q90.jpg', 'https://b2c.jihainet.com/static/uploads/8f/30/40/5bc9a224b81f4.jpg', '', 'local', '1539940900', null);
INSERT INTO `jshop_images` VALUES ('f669696078688c02bbe721ac9d5f0a54', 'O1CN012H2BUk81kovjH1J_!!3241519092.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/76/6d/d5/5bc9a988051b3.jpg', '', 'local', '1539942792', null);
INSERT INTO `jshop_images` VALUES ('f8b31c241ad346fceb55f83fcf2874bb', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/a8/9e/44/5bcd2a79f1ea0.jpg', '', 'local', '1540172409', null);
INSERT INTO `jshop_images` VALUES ('fb594a67a5bd4034879e10b39fc27be9', '罗衣.png', 'http://b2c.jihainet.com/static/uploads/24/db/73/5ba9e21ce529b.png', '', 'local', '1537860124', null);
INSERT INTO `jshop_images` VALUES ('fcbc476de3f2feb0c1eca55406b6a64c', 'O1CN011jjW1JieT3iWJDU_!!2856524584.jpg_430x430q90.', 'https://b2c.jihainet.com/static/uploads/99/3c/3e/5bc9a817e6b9d.jpg', '', 'local', '1539942423', null);
INSERT INTO `jshop_images` VALUES ('fce63f9c69c6c4ec606b544fcc7610a2', 'O1CN0129E4qkPG80nYrJl_!!736758035.jpg_430x430q90.j', 'https://b2c.jihainet.com/static/uploads/dd/bd/35/5bc9a50154075.jpg', '', 'local', '1539941633', null);
INSERT INTO `jshop_images` VALUES ('fcf3bc0c3842963e0ccd606312263f9c', '维卡拉.jpg', 'http://b2c.jihainet.com/static/uploads/8f/d0/58/5ba9e21a038aa.jpg', '', 'local', '1537860122', null);
INSERT INTO `jshop_images` VALUES ('fe91f59b549fab49ca2db1ea9883f8d3', '270x270.jpg', 'https://b2c.jihainet.com/static/uploads/46/92/b7/5bcd2ac6d1d2c.jpg', '', 'local', '1540172486', null);
...
CREATE TABLE `jshop_label` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='标签表';
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='管理员表';

-- ----------------------------
-- Records of jshop_manage
-- ----------------------------
INSERT INTO `jshop_manage` VALUES ('13', 'admin', 'edb3fafdc14e44ae10b2a7d9e024d73c', '', null, null, '1552821388', '1552821388', '1');
...
CREATE TABLE `jshop_manage_role` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='总后台角色表';
...
CREATE TABLE `jshop_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='站内信';
...
CREATE TABLE `jshop_message_center` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='消息中心表';
...
CREATE TABLE `jshop_operation` (
  ...
  KEY `sort` (`sort`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=535 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='权限表';
...
INSERT INTO `jshop_operation` VALUES ('271', '2', '广告位管理', 'AdvertPosition', 'c', '2', '3', '100');
...
INSERT INTO `jshop_operation` VALUES ('277', '2', '广告管理', 'Advertisement', 'c', '2', '3', '100');
...
CREATE TABLE `jshop_operation_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='后台操作记录表';
...
CREATE TABLE `jshop_order_items` (
  ...
  `utime` bigint(12) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='订单明细表';
...
-- ----------------------------
INSERT INTO `jshop_products` VALUES ('1', '1', null, 'P5378659179491', '450.00', '0.00', '600.00', '1', '198', '2', '颜色:红色,规格:规格1', '1', null);
INSERT INTO `jshop_products` VALUES ('2', '1', null, 'P5378659179512', '0.10', '0.00', '600.00', '2', '196', '1', '颜色:白色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('3', '1', null, 'P5378659179940', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:蓝色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('4', '1', null, 'P5378659179961', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:白色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('5', '1', null, 'P5378659179972', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:绿色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('6', '1', null, 'P5378659179981', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:蓝色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('7', '1', null, 'P5378659179993', '450.00', '0.00', '0.00', '2', '196', '0', '颜色:红色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('8', '1', null, 'P5378659180005', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:白色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('9', '1', null, 'P5378659180001', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:绿色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('10', '1', null, 'P5378659180011', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:蓝色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('11', '1', null, 'P5378659180024', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:红色,规格:规格4', '2', null);
INSERT INTO `jshop_products` VALUES ('12', '1', null, 'P5378659180035', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:白色,规格:规格4', '2', null);
INSERT INTO `jshop_products` VALUES ('13', '1', null, 'P5378659180105', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:绿色,规格:规格4', '2', null);
INSERT INTO `jshop_products` VALUES ('14', '1', null, 'P5378659180100', '450.00', '0.00', '0.00', '2', '200', '0', '颜色:蓝色,规格:规格4', '2', null);
INSERT INTO `jshop_products` VALUES ('22', '1', null, 'P5379429769422', '0.00', '0.00', '0.00', '1', '0', '0', 'id', '2', null);
INSERT INTO `jshop_products` VALUES ('23', '2', null, '-1', '600.00', '590.00', '590.00', '1', '98', '0', '颜色:白色,规格:规格1', '1', null);
INSERT INTO `jshop_products` VALUES ('24', '2', null, '-2', '610.00', '600.00', '600.00', '2', '100', '0', '颜色:蓝色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('25', '2', null, '-3', '610.00', '600.00', '600.00', '2', '150', '0', '颜色:紫色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('26', '2', null, '-4', '610.00', '600.00', '600.00', '2', '120', '0', '颜色:白色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('27', '2', null, '-5', '600.00', '600.00', '600.00', '2', '110', '0', '颜色:蓝色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('28', '2', null, '-6', '600.00', '600.00', '600.00', '2', '100', '0', '颜色:紫色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('29', '4', null, '51111', '200.00', '200.00', '200.00', '2', '98', '0', '颜色:红色,规格:规格1', '1', null);
INSERT INTO `jshop_products` VALUES ('30', '4', null, '5222', '209.00', '200.00', '200.00', '2', '130', '0', '颜色:白色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('31', '4', null, '5333', '210.00', '200.00', '200.00', '2', '150', '0', '颜色:红色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('32', '4', null, '5444', '220.00', '200.00', '200.00', '2', '180', '0', '颜色:白色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('33', '5', null, '564456', '200.00', '190.00', '190.00', '1', '200', '0', null, '1', null);
INSERT INTO `jshop_products` VALUES ('34', '7', null, '1111', '99.00', '99.00', '99.00', '2', '299', '0', '颜色:白色,规格:规格1', '1', null);
INSERT INTO `jshop_products` VALUES ('35', '7', null, '222', '98.00', '98.00', '98.00', '2', '300', '0', '颜色:白色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('36', '7', null, '3333', '98.00', '98.00', '99.00', '2', '320', '0', '颜色:白色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('37', '7', null, '4444', '97.00', '98.00', '98.00', '2', '321', '0', '颜色:黑色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('38', '7', null, '5555', '94.00', '94.00', '94.00', '2', '300', '0', '颜色:黑色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('39', '7', null, '6666', '90.00', '90.00', '90.00', '2', '200', '0', '颜色:黑色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('40', '8', null, '21111', '220.00', '220.00', '220.00', '2', '198', '10', '颜色:红色,规格:规格1', '1', null);
INSERT INTO `jshop_products` VALUES ('41', '8', null, '22222', '230.00', '230.00', '230.00', '2', '300', '0', '颜色:红色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('42', '8', null, '23333', '230.00', '230.00', '230.00', '2', '200', '0', '颜色:红色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('43', '8', null, '24444', '225.00', '225.00', '225.00', '2', '200', '0', '颜色:蓝色,规格:规格1', '2', null);
INSERT INTO `jshop_products` VALUES ('44', '8', null, '25555', '225.00', '225.00', '225.00', '2', '300', '0', '颜色:蓝色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('45', '8', null, '26666', '224.00', '224.00', '224.00', '2', '300', '0', '颜色:蓝色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('46', '9', null, '23045242', '300.00', '320.00', '320.00', '1', '499', '0', null, '1', null);
INSERT INTO `jshop_products` VALUES ('47', '10', null, '61111', '69.00', '69.00', '69.00', '2', '289', '0', '颜色:白色,规格:规格2', '1', null);
INSERT INTO `jshop_products` VALUES ('48', '10', null, '62222', '69.00', '69.00', '69.00', '2', '320', '1', '颜色:蓝色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('49', '10', null, '63333', '65.00', '65.00', '65.00', '2', '320', '0', '颜色:棕色,规格:规格2', '2', null);
INSERT INTO `jshop_products` VALUES ('50', '10', null, '64444', '65.00', '65.00', '65.00', '2', '330', '0', '颜色:白色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('51', '10', null, '65555', '66.00', '66.00', '66.00', '2', '300', '0', '颜色:蓝色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('52', '10', null, '66666', '66.00', '66.00', '66.00', '2', '310', '0', '颜色:棕色,规格:规格3', '2', null);
INSERT INTO `jshop_products` VALUES ('56', '2', null, 'P5401938461902', '0.00', '0.00', '0.00', '1', '0', '0', 'id', '2', null);
...
CREATE TABLE `jshop_promotion` (
  ...
  KEY `status` (`status`) USING BTREE,
  KEY `id` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='促销表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='促销条件表';
...
CREATE TABLE `jshop_promotion_result` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `promotion_id` (`promotion_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='促销结果表';
...
CREATE TABLE `jshop_template` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='模板列表';
...
CREATE TABLE `jshop_template_order` (
  ...
  `utime` bigint(12) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='模板订购记录表';
...
CREATE TABLE `jshop_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='用户表';
...
CREATE TABLE `jshop_user_point_log` (
  ...
  `ctime` bigint(12) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='用户积分记录表';
...
CREATE TABLE `jshop_weixin_media_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='微信图文消息表';
...
CREATE TABLE `jshop_weixin_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='微信公众号菜单表';
...
CREATE TABLE `jshop_weixin_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='微信消息表';
